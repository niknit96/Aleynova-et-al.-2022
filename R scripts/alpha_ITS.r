...
# Figure 8c. Shannon′s alpha diversity boxplot (ITS)
...
ggsave("../Figure 8c. Shannon′s alpha diversity boxplot (ITS).png", width = 7, height = 10)
#


# Pairwise Wilcoxon rank sum test of Vitis microbial communities (ITS)
Shannon = pairwise.wilcox.test(alpha_diversity$Shannon, alpha_diversity$Species, p.adjust.method = 'fdr')
print("Pairwise Wilcoxon rank sum test of Vitis microbial communities (ITS)")
Shannon