...
mycolors = c("#FF1202", "#401CE6", "#11a40e", "#c6852f")

# Figure 7d. NMDS ordination plot of Vitis communities (16s)
Vitis = c("V. amurensis", "V. coignetiae", "V. vinifera cv. ‘Cabernet Dorsa’ ", "V. vinifera cv. ‘Syrah’")
...
ggsave("../Figure 7d. NMDS ordination plot of Vitis communities (16s).png", width = 11, height = 10)
#
...
# Supporting information 3. NMDS ordination plot of V. amurensis and V. coignetiae plant samples (16s)
...
ggsave("../Supporting information 3. NMDS ordination plot of V. amurensis and V. coignetiae plant samples (16s).png", width = 11, height = 10)
#


# PERMANOVA test of V. amurensis and V. coignetiae plant's microbial communities (16s)
beta_Plant = adonis2(physeq_for_beta_Plant ~ Plant, data = NMDS2, permutations = 999, method = "bray")
print("PERMANOVA test of V. amurensis and V. coignetiae plant's microbial communities (16s)")
beta_Plant
write.table(beta_Plant, sep = "\t", quote = FALSE, file="../PERMANOVA test of V. amurensis and V. coignetiae plant's microbial communities (16s).txt")

# PERMANOVA test of V. amurensis, V. coignetiae, V. vinifera cv. ‘Cabernet Dorsa’ and V. vinifera cv. ‘Syrah’ microbial communities (16s)
beta_Species = adonis2(physeq_for_beta_Species ~ Species, data = NMDS, permutations = 999, method = "bray")
print("PERMANOVA test of V. amurensis, V. coignetiae, V. vinifera cv. ‘Cabernet Dorsa’ and V. vinifera cv. ‘Syrah’ microbial communities (16s)")
beta_Species
write.table(beta_Species, sep = "\t", quote = FALSE, file="../PERMANOVA test of V. amurensis, V. coignetiae, V. vinifera cv. ‘Cabernet Dorsa’ and V. vinifera cv. ‘Syrah’ microbial communities (16s).txt")
