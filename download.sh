...
&& gzip $DIR/16s/fastq/$sra"_2.fastq" || echo "Can't download $sra. Try run script again." && exit )
done
...
&& gzip $DIR/ITS/fastq/$sra"_2.fastq" || echo "Can't download $sra. Try run script again." && exit )
done
