...
# Supporting information 4. Heatmap for V. amurensis plants (16s)
Heatmap = upset_data
...
png("./Supporting information 4. Heatmap for V. amurensis plants (16s).png",  width = 20, height = 15, units = "in", res = 300)
...
# Supporting information 6. Heatmap for V. coignetiae plants (16s)
Heatmap = upset_data
Heatmap = filter(Heatmap, rowSums(Heatmap) > 0)
...
png("./Supporting information 6. Heatmap for V. coignetiae plants (16s).png",  width = 13, height = 10, units = "in", res = 300)
...
# Supporting information 13. Heatmap for Vitis plants (16s)
Heatmap = upset_data
Heatmap = filter(Heatmap, rowSums(Heatmap) > 0)
...
png("./Supporting information 13. Heatmap for Vitis plants (16s).png",  width = 13, height = 10, units = "in", res = 300)
...
# Figure 3. V. amurensis and V. coignetiae heatmap (16s)
Heatmap = upset_data
Heatmap = filter(Heatmap, rowSums(Heatmap) > 0)
...
png("./Figure 3. V. amurensis and V. coignetiae heatmap (16s).png",  width = 20, height = 15, units = "in", res = 300)
...
# Supporting information 5. Heatmap for V. amurensis plants (culture-depend, 16s)
Heatmap = upset_data
Heatmap = filter(Heatmap, rowSums(Heatmap) > 0)
...
png("./Supporting information 5. Heatmap for V. amurensis plants (culture-depend, 16s).png",  width = 19, height = 12, units = "in", res = 300)
...
# Supporting information 7. Heatmap for V. coignetiae plants (culture-depend, 16s)
Heatmap = upset_data
Heatmap = filter(Heatmap, rowSums(Heatmap) > 0)
...
png("./Supporting information 7. Heatmap for V. coignetiae plants (culture-depend, 16s).png",  width = 10, height = 7, units = "in", res = 300)
