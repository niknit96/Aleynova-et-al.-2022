...
# Figure 1(a) V. amurensis 16s metagenome bar plot
ggplot(Barplot) +
...
ggsave("./Figure 1(a) V. amurensis 16s metagenome bar plot.png", width = 30, height = 20)
#
...
# Figure 2(a) V. coignetiae 16s metagenome bar plot
ggplot(Barplot) +
	geom_col(aes(x = Sample, y = Abundance, fill = Class), colour = "black", linetype = "solid", size = 0.1) +
	scale_fill_manual(values = Barplot_factors[, "color"]) +
	guides(fill = guide_legend(ncol = 1, byrow = TRUE)) +
...
ggsave("./Figure 2(a) V. coignetiae 16s metagenome bar plot.png", width = 18, height = 20)
#
...
# Figure 1(c) V. amurensis 16s cultivation-dependent data bar plot
ggplot(Barplot) +
	geom_col(aes(x = Sample, y = Abundance, fill = Class), colour = "black", linetype = "solid", size = 0.1) +
	scale_fill_manual(values = Barplot_factors[, "color"]) +
	guides(fill = guide_legend(ncol = 1, byrow = TRUE)) +
...
ggsave("./Figure 1(c) V. amurensis 16s cultivation-dependent data bar plot.png", width = 30, height = 20)
#
...
# Figure 2(c) V. coignetiae 16s cultivation-dependent data bar plot
ggplot(Barplot) +
	geom_col(aes(x = Sample, y = Abundance, fill = Class), colour = "black", linetype = "solid", size = 0.1) +
	scale_fill_manual(values = Barplot_factors[, "color"]) +
	guides(fill = guide_legend(ncol = 1, byrow = TRUE)) +
...
ggsave("./Figure 2(c) V. coignetiae 16s cultivation-dependent data bar plot.png", width = 15, height = 20)
#
...
Barplot = Barplot[,c('V. amurensis', 'V. coignetiae', 'V. vinifera-USA', 'V. vinifera-Germany')]
...
# Figure 7(a) Bar plot of comparison of endophytic bacterial communities
ggplot(Barplot) +
	geom_col(aes(x = Sample, y = Abundance, fill = Class), colour = "black", linetype = "solid", size = 0.1) +
	scale_fill_manual(values = Barplot_factors[, "color"]) +
	guides(fill = guide_legend(ncol = 1, byrow = TRUE)) +
...
ggsave("./Figure 7(a) Bar plot of comparison of endophytic bacterial communities.png", width = 22, height = 28)
#