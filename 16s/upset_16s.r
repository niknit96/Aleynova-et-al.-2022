...
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="./Supporting information 4. Intersections in 16s metagenome data of V. amurensis plant samples.txt")
#
...
png("./Figure 1b. Upset diagram for V. amurensis plants (16s).png",  width = 30, height = 15, units = "in", res = 300)
...
colnames(Upset_genus_.txt) = c("Taxa of genus level", "Where present")
Upset_genus_.txt = as.data.frame(Upset_genus_.txt)
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="./Supporting information 6. Intersections in 16s metagenome data of V. coignetiae plant samples.txt")
#
...
png("./Figure 2b. Upset diagram for V. coignetiae plants (16s).png",  width = 10, height = 7, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 35),
	column_title = "", 
...
# Supporting information 13. Intersections in 16s metagenome data of V. amurensis, V. coignetiae and V. vinifera plant samples
...
colnames(Upset_genus_.txt) = c("Taxa of genus level", "Where present")
Upset_genus_.txt = as.data.frame(Upset_genus_.txt)
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="./Supporting information 13. Intersections in 16s metagenome data of V. amurensis, V. coignetiae and V. vinifera plant samples.txt")
#
...
# Figure 7b. Upset diagram for Vitis plants (16s)
png("./Figure 7b. Upset diagram for Vitis plants (16s).png",  width = 10, height = 7, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
...
# Supporting information 5. Intersections in 16s data of cultivate-dependent method of V. amurensis plant samples
upset_data_for_suppl = upset_data[, V_amur]
...
colnames(Upset_genus_.txt) = c("Taxa of genus level", "Where present")
Upset_genus_.txt = as.data.frame(Upset_genus_.txt)
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="./Supporting information 5. Intersections in 16s data of cultivate-dependent method of V. amurensis plant samples.txt")
#
...
# Figure 1d. Upset diagram for V. amurensis plants (16s, culture-depend)
png("./Figure 1d. Upset diagram for V. amurensis plants (16s, culture-depend).png",  width = 20, height = 13, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 35),
	column_title = "", 
...
colnames(Upset_genus_.txt) = c("Taxa of genus level", "Where present")
Upset_genus_.txt = as.data.frame(Upset_genus_.txt)
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="./Supporting information 7. Intersections in 16s data of cultivate-dependent method of V. coignetiae plant samples.txt")
#
...
# Figure 2d. Upset diagram for V. coignetiae plants (16s, culture-depend)
png("./Figure 2d. Upset diagram for V. coignetiae plants (16s, culture-depend).png",  width = 10, height = 7, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 35),
	column_title = "", 
